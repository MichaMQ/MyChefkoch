...
public class StringUtil {
	...
	/**
	 * Ersetzt Werte in [...], wenn vorhanden; Nicht vorhandene Werte werden durch
	 * den Leerstring ersetzt
	 *
	...
	/**
	 * Ersetzt Werte in [...], hierbei kann der Platzhalter ein Token # enthalten,
	 * welches es ermöglicht, Werte aus einem Properties-Objekt zu lesen, welches
	 * Teil der Map ist.
	 *
	 * @param arg    Der zu behandelnde String.
     ...
     *
     * @param algorithm H: MD5 with salt, H2 Bcrypt with salt, H5 Sha256Crypt, H6 Sha512Crypt
    ...
    public static String hashPasswordWithSalt(String password) {
    	...
    	return Sha512Crypt.Sha512_crypt(password, null, 0);
    }

    /**
     * verifies a hashed password, guessing the algorithm
     *
     * @param password plain text password as entered by the user
     * @param hash stored hashed password
     * @return true, if the password was accepted; false otherwise
     */
