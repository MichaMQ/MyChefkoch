...
var author$project$Devs$TypeObject$AddTagToRecipeResp = F2(
	function (a, b) {
		return {$: 'AddTagToRecipeResp', a: a, b: b};
	});
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Devs$Utils$addTagToRecipe = F3(
	function (model, tag, recipeObj) {
		var _n0 = tag.id;
		if (_n0.$ === 'Just') {
			var tagId = _n0.a;
			if (recipeObj.$ === 'Just') {
				var recipe = recipeObj.a;
				var _n2 = recipe.id;
				if (_n2.$ === 'Just') {
					var recipeId = _n2.a;
					return A3(
						author$project$Devs$BackendApi$deleteValue,
						author$project$Devs$TypeObject$AddTagToRecipeResp(tag),
						model.session,
						model.sp.serverProtokoll + (model.sp.serverHost + (model.sp.serverUrlPrefix + (model.sp.apiUrlPrefix + ('/addTagToRecipe?recipeId=' + (elm$core$String$fromInt(recipeId) + ('&tagId=' + elm$core$String$fromInt(tagId))))))));
				} else {
...
var author$project$Devs$TypeObject$NoOpWS = function (a) {
	return {$: 'NoOpWS', a: a};
};
var author$project$Devs$Utils$removeRecipeById = F2(
	function (model, recipeId) {
		if (recipeId.$ === 'Just') {
			var recId = recipeId.a;
			return A3(
				author$project$Devs$BackendApi$deleteValue,
				author$project$Devs$TypeObject$NoOpWS,
				model.session,
				model.sp.serverProtokoll + (model.sp.serverHost + (model.sp.serverUrlPrefix + (model.sp.apiUrlPrefix + ('/removeRecipeById?id=' + elm$core$String$fromInt(recId))))));
		} else {
			return elm$core$Platform$Cmd$none;
		}
	});
var author$project$Devs$TypeObject$RemoveTagFromRec = F2(
	function (a, b) {
		return {$: 'RemoveTagFromRec', a: a, b: b};
	});
var author$project$Devs$Utils$removeTagFromRecipe = F3(
	function (model, tag, recipeId) {
		var _n0 = tag.id;
		if (_n0.$ === 'Just') {
			var tagId = _n0.a;
			return A3(
				...
				model.session,
				model.sp.serverProtokoll + (model.sp.serverHost + (model.sp.serverUrlPrefix + (model.sp.apiUrlPrefix + ('/removeTagFromRecipe?recipeId=' + (elm$core$String$fromInt(recipeId) + ('&tagId=' + elm$core$String$fromInt(tagId))))))));
		} else {
			return elm$core$Platform$Cmd$none;
		}
	});
var author$project$Devs$RecipeEncode$roleEncoder = function (role) {
	if (role.$ === 'ADMIN') {
		return elm$json$Json$Encode$string('ADMIN');
	} else {
		return elm$json$Json$Encode$string('USER');
	}
};
var author$project$Devs$RecipeEncode$personEncoder = function (td) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'firstname',
				elm$json$Json$Encode$string(td.firstname)),
				_Utils_Tuple2(
				'surname',
				elm$json$Json$Encode$string(td.surname)),
				_Utils_Tuple2(
				'role',
				author$project$Devs$RecipeEncode$roleEncoder(td.role)),
				_Utils_Tuple2(
				'uuid',
				elm$json$Json$Encode$string(td.uuid))
			]));
...
var author$project$Devs$RecipeEncode$recipeEncoder = function (rec) {
	var list = _List_fromArray(
		[
			...
			_Utils_Tuple2(
			'person',
			author$project$Devs$RecipeEncode$personEncoder(rec.person)),
			_Utils_Tuple2(
			'ingredients',
...
var author$project$Devs$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'InsertRecipe':
				var newRec = function () {
					var _n5 = model.session;
					if (_n5.$ === 'Just') {
						var session = _n5.a;
						var _n6 = session.person;
						if (_n6.$ === 'Just') {
							var person = _n6.a;
							return _Utils_update(
								author$project$Devs$Objects$getEmptyRecipe,
								{person: person});
						} else {
							return author$project$Devs$Objects$getEmptyRecipe;
						}
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							showEditForm: elm$core$Maybe$Just(author$project$Devs$Objects$BasicForm)
						}),
					elm$core$Platform$Cmd$none);
			case 'SaveRecipe':
				var errorMsg = A2(
					...
					model.selectedRecipe);
				var _n7 = A2(elm$core$Debug$log, 'selectedRecipe: ', model.selectedRecipe);
				var _n8 = A2(elm$core$Debug$log, 'errorMsg: ', errorMsg);
				if (errorMsg.$ === 'Just') {
					var msg1 = errorMsg.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					var _n10 = model.selectedRecipe;
					if (_n10.$ === 'Just') {
						var newRecipe = _n10.a;
						return _Utils_Tuple2(
							model,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								showEditForm: elm$core$Maybe$Nothing
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					var _n11 = A2(elm$core$Debug$log, 'error: ', error);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'DeleteRecipe':
				...
				if (_n12.$ === 'Just') {
					...
					return _Utils_Tuple2(
						...
						A2(author$project$Devs$Utils$removeRecipeById, model, recipe.id));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			...
			case 'SetChoosenTag':
				...
				var tagList = function () {
					var _n19 = model.kl.tagList;
					if (_n19.$ === 'Just') {
						var tagListTmp = _n19.a;
						return tagListTmp;
					} else {
						return _List_Nil;
					}
			...
			case 'AddTagToRecipe':
				...
				if (_n20.$ === 'Just') {
					...
					return _Utils_Tuple2(
						...
						A3(author$project$Devs$Utils$addTagToRecipe, model, newTag, model.selectedRecipe));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'DeleteTag':
				...
				if (_n37.$ === 'Just') {
					...
					if (_n38.$ === 'Just') {
						...
						return _Utils_Tuple2(
							model,
							A3(author$project$Devs$Utils$removeTagFromRecipe, model, tag, recId));
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
				} else {
			...
			case 'AddTagToRecipeResp':
				if (msg.b.$ === 'Ok') {
					var newTag = msg.a;
					var _n46 = model.selectedRecipe;
					if (_n46.$ === 'Just') {
						var recipe = _n46.a;
						return _Utils_Tuple2(
							_Utils_update(
...
var author$project$Devs$TypeObject$Logout = {$: 'Logout'};
...
var author$project$Pages$EditorTabs$Tab1$viewImagePreview = F2(
	function (image, base64Img) {
		if (image.$ === 'Just') {
			var img = image.a;
			return A2(
			...
			if (base64Img.$ === 'Just') {
				var imgSrc = base64Img.a;
				return A2(elm$core$String$startsWith, '/', imgSrc) ? A2(
					elm$html$Html$div,
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$src('data:image/jpeg;base64,' + imgSrc)
										]),
									_List_Nil)
								]))
...
var author$project$Pages$EditorTabs$Tab1$showTab = function (model) {
	...
	var numberCommentValue = function () {
		var _n11 = mod_rec.number_comment;
		if (_n11.$ === 'Just') {
			var val = _n11.a;
			return val;
		} else {
	...
	var proteinValue = function () {
		var _n9 = mod_rec.nv_protein;
		if (_n9.$ === 'Just') {
			var val = _n9.a;
	...
	var carbohydratesValue = function () {
		var _n0 = mod_rec.nv_carbohydrates;
		if (_n0.$ === 'Just') {
			var val = _n0.a;
			return elm$core$String$fromFloat(val);
		} else {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('nv_energy')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$placeholder('in kCal pro Portion'),
										elm$html$Html$Attributes$step('0.1'),
										elm$html$Html$Attributes$id('nv_energy'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('nv_carbohydrates')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$placeholder('in g pro Portion'),
										elm$html$Html$Attributes$step('0.1'),
										elm$html$Html$Attributes$id('nv_carbohydrates'),
										elm$html$Html$Attributes$value(carbohydratesValue)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('nv_fat')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$placeholder('in g pro Portion'),
										elm$html$Html$Attributes$step('0.1'),
										elm$html$Html$Attributes$id('nv_fat'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('nv_protein')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$placeholder('in g pro Portion'),
										elm$html$Html$Attributes$step('0.1'),
										elm$html$Html$Attributes$id('nv_protein'),
										elm$html$Html$Attributes$value(proteinValue)
									]),
								_List_Nil)
							]))
					])),
				A2(author$project$Pages$EditorTabs$Tab1$viewImagePreview, model.recImage, mod_rec.image)
			]));
};
var author$project$Devs$TypeObject$ChooseNewTag = {$: 'ChooseNewTag'};
var author$project$Devs$TypeObject$DeleteTag = function (a) {
	return {$: 'DeleteTag', a: a};
};
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Devs$TypeObject$DeleteTag(tag))
								]),
							_List_fromArray(
								[
									elm$html$Html$text('-')
...
var author$project$Pages$RecipeView$viewRecipe = F3(
	function (session, rec, sp) {
		...
		var number_for_display = function () {
			var _n7 = rec.number_for_display;
			if (_n7.$ === 'Just') {
				var n = _n7.a;
				return n;
			} else {
								...
								[
									...
									_List_fromArray(
										[
											...
											if (_n0.$ === 'Just') {
												...
												return A2(
													...
													_List_fromArray(
														[
															elm$html$Html$text(
															'Kalorien: ' + (elm$core$String$fromFloat(energy) + ' kCal'))
														]));
											} else {
												return elm_community$html_extra$Html$Extra$nothing;
											}
											...
											function () {
											var _n1 = rec.nv_carbohydrates;
											if (_n1.$ === 'Just') {
												var carbohydrates = _n1.a;
												return A2(
													elm$html$Html$div,
													_List_fromArray(
														[
													...
													_List_fromArray(
														[
															elm$html$Html$text(
															'Kohlenhydrate: ' + (elm$core$String$fromFloat(carbohydrates) + ' g'))
														]));
											} else {
												return elm_community$html_extra$Html$Extra$nothing;
											}
											...
											if (_n2.$ === 'Just') {
												...
												return A2(
													...
													_List_fromArray(
														[
															elm$html$Html$text(
															'Fett:' + (elm$core$String$fromFloat(fat) + ' g'))
														]));
											} else {
												return elm_community$html_extra$Html$Extra$nothing;
											}
											...
											if (_n3.$ === 'Just') {
												...
												return A2(
													...
													_List_fromArray(
														[
															elm$html$Html$text(
															'Eiweiß: ' + (elm$core$String$fromFloat(protein) + ' g'))
														]));
											} else {
												return elm_community$html_extra$Html$Extra$nothing;
											}
...
var author$project$Pages$OverViewPage$viewOverview = F2(
	function (model, alertMsg) {
		...
		var actionButton = A2(author$project$Devs$Utils$isLoggedIn, model.session, elm$core$Maybe$Nothing) ? _List_fromArray(
			[
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Devs$TypeObject$Logout)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('ausloggen')
					]))
			]) : _List_fromArray(
			[
				A2(
